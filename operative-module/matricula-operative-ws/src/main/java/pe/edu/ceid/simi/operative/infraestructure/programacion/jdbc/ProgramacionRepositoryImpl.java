...
public class ProgramacionRepositoryImpl implements ProgramacionRepository{
	...
	public List<ProgramacionDTO> getProgramacion() {
		String query = "SELECT PROG.ID_PROGCURSO, PROG.FK_ID_PROG_DOC_CUR, PROG.FK_ID_AULA, PROG.FK_ID_GRUPOHORARIO, PROG.FK_ID_ESTADO_PROGCURSO,"
				+ "IDIOMA.NOM_IDIOMA, CONCAT(NIVEL.NOM_NIVEL,' ', CURSO.CICLO), CONCAT(PER.NOMBRE, ' ', PER.APELLIDO_PAT, ' ', APELLIDO_MAT),"
				+ "GHOR.NOM_GRUPOHORARIO, CONCAT('(', HCLA.HORA_INICIO, ' - ', HCLA.HORA_SALIDA,')')" 
